...
-- System settings
INSERT INTO public.system_settings (setting_key, setting_value, description, is_public, updated_by) VALUES
('clinic_name', '"MediCare Clinic"', 'Name of the clinic', true, '00000000-0000-0000-0000-000000000000'),
('clinic_address', '"123 Healthcare Street, Medical City, MC 12345"', 'Clinic address', true, '00000000-0000-0000-0000-000000000000'),
('clinic_phone', '"+1-555-0123"', 'Clinic phone number', true, '00000000-0000-0000-0000-000000000000'),
('clinic_email', '"info@medicare-clinic.com"', 'Clinic email address', true, '00000000-0000-0000-0000-000000000000'),
('appointment_duration', '30', 'Default appointment duration in minutes', false, '00000000-0000-0000-0000-000000000000'),
('working_hours_start', '"09:00"', 'Default working hours start time', false, '00000000-0000-0000-0000-000000000000'),
('working_hours_end', '"17:00"', 'Default working hours end time', false, '00000000-0000-0000-0000-000000000000')
...
('Common Cold', 'Respiratory', 'Patient presents with symptoms consistent with viral upper respiratory tract infection. Symptoms include nasal congestion, rhinorrhea, mild sore throat, and low-grade fever. Physical examination reveals clear nasal discharge and mild throat erythema. No signs of bacterial infection.', 'J00', '00000000-0000-0000-0000-000000000000'),
('Hypertension', 'Cardiovascular', 'Patient diagnosed with essential hypertension. Blood pressure readings consistently elevated above 140/90 mmHg on multiple occasions. No evidence of secondary causes. Recommend lifestyle modifications including diet, exercise, and stress management along with antihypertensive medication.', 'I10', '00000000-0000-0000-0000-000000000000'),
('Type 2 Diabetes', 'Endocrine', 'Patient diagnosed with Type 2 Diabetes Mellitus. HbA1c levels elevated above 6.5%. Fasting glucose consistently above 126 mg/dL. Recommend dietary modifications, regular exercise, blood glucose monitoring, and antidiabetic medication. Patient education on diabetes management provided.', 'E11.9', '00000000-0000-0000-0000-000000000000'),
('Gastritis', 'Gastrointestinal', 'Patient presents with symptoms of gastritis including epigastric pain, nausea, and bloating. Physical examination reveals epigastric tenderness. Recommend proton pump inhibitor therapy, dietary modifications, and avoidance of NSAIDs and alcohol.', 'K29.7', '00000000-0000-0000-0000-000000000000'),
('Migraine', 'Neurological', 'Patient presents with recurrent headaches consistent with migraine without aura. Unilateral throbbing pain with associated nausea and photophobia. Duration 4-72 hours. Recommend trigger identification, lifestyle modifications, and appropriate abortive therapy.', 'G43.9', '00000000-0000-0000-0000-000000000000'),
('Anxiety Disorder', 'Psychiatric', 'Patient presents with symptoms of generalized anxiety disorder including excessive worry, restlessness, fatigue, and difficulty concentrating. Symptoms present for more than 6 months and significantly impact daily functioning. Recommend counseling and consider anxiolytic medication.', 'F41.1', '00000000-0000-0000-0000-000000000000')
...
'Rest, increase fluid intake, avoid cold foods. Return if symptoms worsen or persist beyond 7 days.', '00000000-0000-0000-0000-000000000000'),
...
'Monitor blood pressure regularly, follow low-sodium diet, exercise regularly. Follow-up in 4 weeks.', '00000000-0000-0000-0000-000000000000'),
...
'Follow diabetic diet, monitor blood sugar regularly, exercise as tolerated. Follow-up in 2 weeks.', '00000000-0000-0000-0000-000000000000'),
...
'Avoid spicy foods, eat small frequent meals, avoid NSAIDs and alcohol. Follow-up in 2 weeks.', '00000000-0000-0000-0000-000000000000'),
...
'Identify and avoid triggers, maintain regular sleep schedule, stay hydrated. Return if headaches increase in frequency or severity.', '00000000-0000-0000-0000-000000000000')

ON CONFLICT (name, category) DO NOTHING;

-- Sample consultation templates
INSERT INTO public.consultation_templates (name, type, content, created_by) VALUES
('General Checkup', 'diagnosis', 'Patient appears well. Vital signs stable. No acute distress noted. Physical examination unremarkable. Continue current medications and lifestyle modifications. Routine follow-up recommended.', '00000000-0000-0000-0000-000000000000'),
('Follow-up Visit', 'diagnosis', 'Patient returns for follow-up. Symptoms have improved since last visit. Current treatment plan appears effective. Continue current regimen with minor adjustments as needed.', '00000000-0000-0000-0000-000000000000'),
('Acute Illness', 'diagnosis', 'Patient presents with acute onset of symptoms. Physical examination reveals findings consistent with clinical presentation. Appropriate treatment initiated. Patient advised to return if symptoms worsen.', '00000000-0000-0000-0000-000000000000'),
('Chronic Disease Management', 'treatment', 'Continue current management plan. Monitor disease progression and medication effectiveness. Lifestyle modifications reinforced. Regular follow-up scheduled to assess treatment response.', '00000000-0000-0000-0000-000000000000'),
('Medication Review', 'prescription', 'Current medications reviewed for effectiveness and side effects. Dosage adjustments made as appropriate. Patient counseled on proper medication administration and potential side effects.', '00000000-0000-0000-0000-000000000000'),
('Preventive Care', 'followup', 'Preventive care measures discussed including screening recommendations, vaccinations, and lifestyle modifications. Patient education provided on disease prevention strategies.', '00000000-0000-0000-0000-000000000000')
